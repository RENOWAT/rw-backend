...
public class PdfCoreBuilder {
    ...
    private static final int BARCODE_WIDTH = 20;
    ...
    public PdfCoreBuilder(String path, String file) {
        ...
        try {
            this.document = new Document(new PdfDocument(new PdfWriter(filename)), PageSize.A4);
    ...
    public PdfCoreBuilder head() {
        this
                .paragraphEmphasized("Renowat")
                .paragraphEmphasized("Tfn: +34 913366011")
                .paragraph("NIF: Q2818015F   -   Calle Alan Turing s/n, 28031 Madrid")
                .paragraph("Email: atencion.cliente@renowat.es   -   Web: renowat.es")
                .line();
        return this;
    }
    ...
    public PdfCoreBuilder foot() {
        this
                .line()
                .paragraphEmphasized("Renowat, tu comercializadora de confianza")
                .paragraphEmphasized(" ")
                .line();
        return this;
    }
